...
&例子1：P = [0.01, ... 0.01, p_a = 0.02, 0.01, ... 0.01] \quad 且a为正确token，即预测正确 \\
&例子2：P = [0.01, ... 0.01, p_a = 0.8, 0.01, ... 0.01] \quad 且a为正确token，即预测正确 \\
&例子3：P = [0.01, ... 0.01, p_a = 0.02, 0.01, ... 0.01] \quad 且a为不正确token，即预测错误 \\
&例子4：P = [0.01, ... 0.01, p_a = 0.8, 0.01, ... 0.01] \quad 且a为不正确token，即预测错误 \\
\end{align*}
$$
